...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  const navConfig = [
    {
      title: 'dashboard',
      path: `/dashboard/${id}/app`,
      icon: getIcon('eva:pie-chart-2-fill'),
    },
    {
      title: 'twitter',
      path: `/dashboard/${id}/twitter`,
      icon: getIcon('eva:twitter-outline'),
    },
    {
      title: 'facebook',
      path: `/dashboard/${id}/facebook`,
      icon: getIcon('eva:facebook-outline'),
    },
    {
      title: 'instagram',
      path: `/dashboard/${id}/insta`,
      icon: getIcon('eva:camera-outline'),
    },
    {
      title: 'custom',
      path: `/dashboard/${id}/custom`,
